...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->AuthLink->link(__('List Users'), ['plugin' => 'CakeDC/Users', 'controller' => 'Users', 'action' => 'index']);?></li> 
        <li><?= $this->AuthLink->link(__('New User'), ['plugin' => 'CakeDC/Users', 'controller' => 'Users', 'action' => 'add']) ?></li>
    </ul>
</nav>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $bookmark->has('user') ? $this->Html->link($bookmark->user->id, ['plugin' => 'CakeDC/Users', 'controller' => 'Users', 'action' => 'view', $bookmark->user->id]) : '' ?></td>
